    ...
    <section id="delegate" className="py-20 relative z-10 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <GlassCard className="relative p-8 sm:p-12 overflow-hidden border-[#00FF87]/30">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-[radial-gradient(circle,_rgba(0,255,135,0.12)_0%,_transparent_70%)] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0A1628] border border-[#00FF87]/40 text-xs font-mono text-[#00FF87] tracking-wider uppercase">
                <UserCheck className="w-3.5 h-3.5" />
                <span>INDIVIDUAL PARTICIPATION</span>
              </div>

              <div className="space-y-2">
                <h2 className="text-3xl sm:text-4xl font-extrabold text-[#FAFBFC]">
              ...
              <p className="text-base text-[#E8F4F8]/80 leading-relaxed max-w-2xl">
              ...
              <div className="space-y-2.5 pt-2">
                {features.map((feat) => (
                  <div key={feat} className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-[#E8F4F8]/90">{feat}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="w-full max-w-sm p-6 rounded-3xl bg-[#0A1628]/90 border border-[#00FF87]/30 text-center space-y-6 shadow-2xl relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#00FF87]/20 to-[#00D4FF]/20 border border-[#00FF87]/40 flex items-center justify-center text-[#00FF87] mx-auto">
                  <Globe className="w-8 h-8 animate-pulse" />
                </div>

                <div className="space-y-1">
                  <span className="block text-2xl font-extrabold font-mono text-[#FAFBFC]">
                    Delegate Pass
                  </span>
                ...
                <div className="p-4 rounded-xl bg-[#050B1A] border border-[#E8F4F8]/10 text-xs text-[#E8F4F8]/70 space-y-1">
                  <div className="flex justify-between">
                    <span>Access:</span>
                    <span className="font-mono text-[#FAFBFC]">Full 3 Days</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Includes:</span>
                ...
                <p className="text-[11px] text-[#E8F4F8]/50 italic">
