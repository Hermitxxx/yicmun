...
export default function CampusRegistration() {
  ...
  return (
    <section id="campus" className="py-20 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <GlassCard className="relative p-8 sm:p-12 overflow-hidden border-[#00D4FF]/30">
          
          {/* Ambient Glow background */}
          <div className="absolute top-0 left-0 w-96 h-96 rounded-full bg-[radial-gradient(circle,_rgba(0,212,255,0.12)_0%,_transparent_70%)] pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            {/* Left Visual Badge */}
            <div className="lg:col-span-5 flex justify-center order-2 lg:order-1">
              <div className="w-full max-w-sm p-6 rounded-3xl bg-[#0A1628]/90 border border-[#00D4FF]/30 text-center space-y-6 shadow-2xl relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#00D4FF]/20 to-[#7B2FBE]/20 border border-[#00D4FF]/40 flex items-center justify-center text-[#00D4FF] mx-auto">
                ...
                <div className="p-4 rounded-xl bg-[#050B1A] border border-[#E8F4F8]/10 text-xs text-[#E8F4F8]/70 space-y-2">
            ...
            <div className="lg:col-span-7 space-y-6 order-1 lg:order-2">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0A1628] border border-[#00D4FF]/40 text-xs font-mono text-[#00D4FF] tracking-wider uppercase">
