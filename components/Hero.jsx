      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="inline-flex items-center justify-center">
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-arctic-blue/90 border border-[#00FF87]/40 text-sm sm:text-base font-mono font-semibold text-[#00FF87] tracking-[0.3em] uppercase backdrop-blur-md shadow-lg shadow-[#00FF87]/10">
          ...
          <motion.div variants={itemVariants} className="space-y-2 max-w-3xl">
            <h1 className="text-6xl sm:text-8xl md:text-9xl font-extrabold tracking-widest text-snow leading-none uppercase">
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center items-center gap-2.5 text-base sm:text-xl md:text-2xl font-extrabold tracking-wider text-frost-white pt-1"
          >
            <span className="text-frost-white/40">&quot;</span>
            {mottoWords.map((word, idx) => (
              <motion.span
                ...
                className={
                  idx === 0
                    ? "text-aurora-green glow-text-green"
                    : idx === 1
                      ? "text-ice-cyan glow-text-cyan"
                      : "text-glacier-pink drop-shadow-[0_0_15px_rgba(255,51,181,0.6)]"
                }
              >
                {word}
              </motion.span>
          ...
          <motion.div variants={itemVariants} className="pt-1">
            <span className="inline-block text-xs sm:text-sm font-mono tracking-[0.25em] text-snow uppercase font-bold px-4 py-1.5 rounded-md bg-arctic-blue/80 border border-frost-white/15">
